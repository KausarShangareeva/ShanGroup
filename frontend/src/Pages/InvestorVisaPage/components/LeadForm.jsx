...
// Premium dark lead form — silver/blue accent instead of gold.
const ACCENT_BG = "linear-gradient(180deg, oklch(0.88 0.025 240) 0%, oklch(0.72 0.04 240) 100%)";
const ACCENT_TEXT = "#1a2030";
const ACCENT_FAINT = "rgba(200,215,235,.95)";

export default function LeadForm() {
  const isMobile = useIsMobile();
  const t = useTranslations("InvestorVisaPage.leadForm");
        ...
        >
          <div
            ...
            style={{
              ...
              borderRadius: 999,
              background:
                "radial-gradient(circle, oklch(0.78 0.05 240 / .25), transparent 70%)",
              pointerEvents: "none",
            }}
          />
            ...
            >
              ...
              >
                <input
                  ...
                  style={{
                    margin: 0,
                    marginTop: 3,
                    accentColor: "oklch(0.78 0.025 240)",
                    width: 16,
                    height: 16,
                    flexShrink: 0,
                  }}
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 700,
                  boxShadow:
                    "0 10px 24px oklch(0.72 0.04 240 / .35), inset 0 1px 0 rgba(255,255,255,.5)",
                  marginTop: 8,
  ...
  return (
    <button
      ...
      style={{
        ...
        background: active ? ACCENT_FAINT : "rgba(255,255,255,.06)",
        color: active ? ACCENT_TEXT : "rgba(255,255,255,.85)",
        fontSize: size === "sm" ? 12 : 12.5,
        fontWeight: 600,
        textAlign: "center",
        border: active
          ? `1px solid ${ACCENT_FAINT}`
