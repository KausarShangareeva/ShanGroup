...
// Lead form — premium dark surface, всегда тёмный фон (#0A0A0B) в обеих темах.
// Gold accent (--gold-warm) для бейджа и кнопок.
export default function LeadForm() {
  const isMobile = useIsMobile();
  const t = useTranslations("OffPlanPage.leadForm");
