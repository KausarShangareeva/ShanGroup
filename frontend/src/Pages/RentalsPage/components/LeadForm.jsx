...
// Premium dark lead form — фон #0A0A0B всегда, gold accents.
export default function LeadForm() {
  const isMobile = useIsMobile();
  const t = useTranslations("RentalsPage.leadForm");
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <FormBlockLabel>{formCfg.strategyLabel}</FormBlockLabel>
              <div
                style={{
                  display: "grid",
              ...
              >
                {formCfg.strategies.map((g) => {
                  const active = form.strategy === g.id;
                  return (
                    <ToggleChip
                      key={g.id}
                      active={active}
                      onClick={() => setForm({ ...form, strategy: g.id })}
                    >
                      {g.l}
                    </ToggleChip>
                  );
