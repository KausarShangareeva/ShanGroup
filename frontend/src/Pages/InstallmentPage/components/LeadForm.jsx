...
// Premium dark lead form — teal accent palette (vs gold/silver на других визах).
const ACCENT_BG =
  "linear-gradient(180deg, oklch(0.72 0.13 165) 0%, oklch(0.55 0.13 165) 100%)";
const ACCENT_TEXT = "#0A1416";

export default function LeadForm() {
  const isMobile = useIsMobile();
  const t = useTranslations("InstallmentPage.leadForm");
        ...
        >
          <div
            ...
            style={{
              ...
              borderRadius: 999,
              background:
                "radial-gradient(circle, oklch(0.62 0.13 165 / .22), transparent 70%)",
              pointerEvents: "none",
            }}
          />
          ...
          >
            ...
            >
              ...
              <FormBlockLabel>{formCfg.downLabel}</FormBlockLabel>
              <div
                style={{
                  display: "grid",
              ...
              >
                {formCfg.downs.map((d) => (
                  <ToggleChip
                    key={d.id}
                    active={form.down === d.id}
                    size="sm"
                    onClick={() => setForm({ ...form, down: d.id })}
                  >
                    {d.l}
                  </ToggleChip>
                ))}
              ...
              >
                <input
                  ...
                  style={{
                    margin: 0,
                    marginTop: 3,
                    accentColor: "oklch(0.62 0.13 165)",
                    width: 16,
                    height: 16,
                    flexShrink: 0,
                  }}
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 700,
                  boxShadow:
                    "0 10px 24px oklch(0.55 0.13 165 / .35), inset 0 1px 0 rgba(255,255,255,.4)",
                  marginTop: 8,
  ...
  return (
    <button
      ...
      style={{
        ...
        background: active ? "oklch(0.62 0.13 165)" : "rgba(255,255,255,.06)",
        color: active ? ACCENT_TEXT : "rgba(255,255,255,.85)",
        fontSize: size === "sm" ? 12 : 12.5,
        fontWeight: 600,
        textAlign: "center",
        border: active
          ? "1px solid oklch(0.62 0.13 165)"
