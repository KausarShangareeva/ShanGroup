...
export default function CompareVisas() {
  const isMobile = useIsMobile();
  const t = useTranslations("GoldenVisaPage.compareVisas");
        ...
        >
          <div style={{ minWidth: 720 }}>
            ...
            >
              ...
              />
              <ColumnHeader title={headers.eu} note={headers.euNote} />
            </div>
            {rows.map((r, i) => (
              <div
                key={r.l}
              ...
              >
                ...
                <CompareCell value={r.g} winner={r.gw} />
                <CompareCell value={r.i} winner={r.iw} />
                <CompareCell value={r.e} winner={r.ew} />
              </div>
            ))}
          </div>
        </div>
...
function ColumnHeader({ title, note, gold }) {
  return (
    <div>
      ...
      <div
        style={{
          fontSize: 9.5,
          color: gold ? "oklch(0.78 0.13 80)" : "var(--muted)",
          fontFamily: "'JetBrains Mono', monospace",
          letterSpacing: ".14em",
          textTransform: "uppercase",
