...
// Изображения статичны (URL не локализуется) — порядок совпадает с items[i].
...
export default function Listings() {
  ...
  const t = useTranslations("GoldenVisaPage.listings");
  ...
  const includesLabel = t("includesLabel");
              ...
              <div style={{ padding: 18 }}>
                ...
                >
                  <svg
                    ...
                    strokeWidth="1.6"
                  >
                    <path d="M7 1 L9 5 L13 5.5 L10 8.5 L11 13 L7 11 L3 13 L4 8.5 L1 5.5 L5 5 Z" />
                  </svg>
                  {includesLabel} {it.visa}
                </div>
              </div>
            </article>
          ))}
