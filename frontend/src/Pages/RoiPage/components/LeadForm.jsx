...
// Premium dark lead form — green accent (биржевая зелёная "доходность").
// Цвета захардкожены, чтобы не инвертироваться в тёмной теме.
const ACCENT_BG =
  "linear-gradient(180deg, oklch(0.7 0.16 155) 0%, oklch(0.5 0.16 155) 100%)";
const ACCENT_TEXT = "#0A0A0B";

export default function LeadForm() {
  const isMobile = useIsMobile();
  const t = useTranslations("RoiPage.leadForm");
        ...
        >
          <div
            ...
            style={{
              ...
              borderRadius: 999,
              background:
                "radial-gradient(circle, oklch(0.45 0.16 155 / .35), transparent 70%)",
              pointerEvents: "none",
            }}
          />
            ...
            >
              ...
              >
                <input
                  ...
                  style={{
                    margin: 0,
                    marginTop: 3,
                    accentColor: "oklch(0.66 0.16 155)",
                    width: 16,
                    height: 16,
                    flexShrink: 0,
                  }}
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 700,
                  boxShadow:
                    "0 10px 24px oklch(0.5 0.16 155 / .35), inset 0 1px 0 rgba(255,255,255,.4)",
                  marginTop: 8,
  ...
  return (
    <button
      ...
      style={{
        ...
        padding: "10px 6px",
        borderRadius: 10,
        background: active ? "oklch(0.66 0.16 155)" : "rgba(255,255,255,.06)",
        color: active ? ACCENT_TEXT : "rgba(255,255,255,.85)",
        fontSize: 12,
        fontWeight: 600,
        textAlign: "center",
        border: active
          ? "1px solid oklch(0.66 0.16 155)"
