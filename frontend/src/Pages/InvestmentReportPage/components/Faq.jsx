...
// First item opens by default — same pattern as the other landings so the
// section never shows an empty accordion shell.
export default function Faq() {
  const isMobile = useIsMobile();
  const t = useTranslations("InvestmentReportPage.faq");
