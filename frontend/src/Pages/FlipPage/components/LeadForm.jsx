...
export default function LeadForm() {
  ...
  const t = useTranslations("FlipPage.leadForm");
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <FormBlockLabel>{formCfg.capitalLabel}</FormBlockLabel>
              <div
                style={{
                  display: "grid",
              ...
              >
                {formCfg.capitals.map((b) => (
                  <ToggleChip
                    key={b.id}
                    active={form.capital === b.id}
                    size="sm"
                    onClick={() => setForm({ ...form, capital: b.id })}
                  >
                    {b.l}
                  </ToggleChip>
                ))}
              ...
              <FormBlockLabel>{formCfg.horizonLabel}</FormBlockLabel>
              <div
                style={{
                  display: "grid",
                  gridTemplateColumns: isMobile
              ...
              >
                {formCfg.horizons.map((g) => (
                  <ToggleChip
                    key={g.id}
                    active={form.horizon === g.id}
                    size="sm"
                    onClick={() => setForm({ ...form, horizon: g.id })}
                  >
                    {g.l}
                  </ToggleChip>
                ))}
