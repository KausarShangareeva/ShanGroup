...
// Dark CTA surface — always #0A0A0B so the gold accent reads at full strength
// regardless of theme. Matches GoldenVisaPage / RoiPage LeadForm pattern.
const ACCENT_BG =
  "linear-gradient(180deg, oklch(0.7 0.13 80) 0%, oklch(0.5 0.13 70) 100%)";
const ACCENT_FG = "#0A0A0B";

export default function LeadForm() {
  const isMobile = useIsMobile();
  const t = useTranslations("UaeTaxGuidePage.leadForm");
          ...
          >
            <div
              style={{
                ...
                placeItems: "center",
                color: "#fff",
                boxShadow: "0 14px 30px var(--tx-accent-glow)",
              }}
            >
            ...
            >
              <span
                style={{
                  ...
                  height: 8,
                  borderRadius: 99,
                  background: "var(--tx-savings-deep)",
                  flexShrink: 0,
                }}
              />
        ...
        >
          <div
            ...
            style={{
              ...
              borderRadius: 999,
              background:
                "radial-gradient(circle, oklch(0.55 0.14 75 / .35), transparent 70%)",
              pointerEvents: "none",
            }}
          />
          <div
            ...
            style={{
              ...
              borderRadius: 999,
              background:
                "radial-gradient(circle, oklch(0.45 0.16 145 / .22), transparent 70%)",
              pointerEvents: "none",
            }}
          />
          ...
          >
            ...
            >
              ...
              >
                {formCfg.incomes.map((i) => (
                  <ToggleChip
                    key={i.id}
                    active={form.income === i.id}
                    onClick={() => setForm({ ...form, income: i.id })}
                  >
                    {i.l}
                  </ToggleChip>
                ))}
              ...
              <FormBlockLabel>{formCfg.fromLabel}</FormBlockLabel>
              <FormInput
                value={form.from}
                onChange={(v) => setForm({ ...form, from: v })}
                placeholder={formCfg.fromPlaceholder}
                required={false}
              />
              ...
              >
                <input
                  ...
                  style={{
                    margin: 0,
                    marginTop: 2,
                    accentColor: "oklch(0.66 0.13 75)",
                    width: 16,
                    height: 16,
                    flexShrink: 0,
                  }}
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 700,
                  boxShadow:
                    "0 10px 28px var(--tx-accent-glow), inset 0 1px 0 rgba(255,255,255,.4)",
  ...
  return (
    <button
      ...
      style={{
        ...
        padding: "10px 8px",
        borderRadius: 10,
        background: active ? "oklch(0.5 0.13 70)" : "rgba(255,255,255,.06)",
        color: active ? "#fff" : "rgba(255,255,255,.85)",
        fontSize: 12,
        fontWeight: 600,
        textAlign: "center",
        border: active
          ? "1px solid oklch(0.5 0.13 70)"
